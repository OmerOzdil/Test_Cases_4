...
public class BrowserUtils {
    ...
    public static void verifyElementDisplayed(By by) {
        try {
      Assert.assertTrue("Element not visible: " + by, Driver.get().findElement(by).isDisplayed());        } catch (NoSuchElementException e) {
            e.printStackTrace();
    ...
    public static void verifyElementNotDisplayed(By by) {
        try {
            Assert.assertFalse("Element should not be visible: " + by, Driver.get().findElement(by).isDisplayed());        } catch (NoSuchElementException e) {
            e.printStackTrace();
